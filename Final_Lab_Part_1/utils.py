...
class STL10_Dataset(Dataset):
    def __init__(self,root,train=True,transform = None, N=100):
        ...
        if train:
            datapth = 'E:/PhD-term3/TAlab5/team20/data/stl10_binary/train_X.bin'
            lbpth   = 'E:/PhD-term3/TAlab5/team20/data/stl10_binary/train_y.bin'
            self.data = read_all_images(datapth)
            self.label= read_labels(lbpth)
        else:
            datapth = 'E:/PhD-term3/TAlab5/team20/data/stl10_binary/test_X.bin'
            lbpth = 'E:/PhD-term3/TAlab5/team20/data/stl10_binary/test_y.bin'
            self.data = read_all_images(datapth)
            self.label = read_labels(lbpth)
